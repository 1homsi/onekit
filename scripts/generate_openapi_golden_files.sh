...
# Build the plugin
echo "Building protoc-gen-onekit-openapiv3 plugin..."
cd "$ROOT_DIR"
go build -o protoc-gen-onekit-openapiv3-golden ./cmd/protoc-gen-onekit-openapiv3

# Set up paths
PLUGIN_PATH="$ROOT_DIR/protoc-gen-onekit-openapiv3-golden"
...
for proto_file in "${PROTO_FILES[@]}"; do
    ...
    protoc \
        --plugin=protoc-gen-onekit-openapiv3="$PLUGIN_PATH" \
        --onekit-openapiv3_out="$GOLDEN_YAML_DIR" \
    ...
    protoc \
        --plugin=protoc-gen-onekit-openapiv3="$PLUGIN_PATH" \
        --onekit-openapiv3_out="$GOLDEN_JSON_DIR" \
        --onekit-openapiv3_opt=format=json \
        --proto_path="$PROTO_DIR" \
        --proto_path="$ROOT_DIR/proto" \
