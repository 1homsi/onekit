"""End-to-end demo for protoc-gen-onekit-py-client.
...
# notes by tag returns Note[] directly thanks to the (onekit.http.unwrap)
...
def section7_advanced_features() -> None:
    ...
    # The (onekit.http.unwrap) annotation on NoteList.notes collapses the
...
def main() -> None:
    ...
    print("Showcases every feature of protoc-gen-onekit-py-client\n")
