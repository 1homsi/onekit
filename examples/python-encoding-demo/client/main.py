"""End-to-end encoding-demo for protoc-gen-onekit-py-client.
...
def section_bytes(client: EncodingDemoServiceClient) -> None:
    ...
    check("base64 → bytes round-trip", b64.data, b"Hello, onekit!")
...
def section_flatten(client: EncodingDemoServiceClient) -> None:
    ...
    check("wire form has 'author_street'", wire.get("author_street"), "1 Onekit Way")
