...
// MarshalJSONOnekit implements onekitMarshaler for Int64EncodingTest.
...
func (x *Int64EncodingTest) MarshalJSONOnekit(opts protojson.MarshalOptions) ([]byte, error) {
	if x == nil {
...
// UnmarshalJSONOnekit implements onekitUnmarshaler for Int64EncodingTest.
// This method handles int64_encoding=NUMBER fields: number_int64, number_uint64, number_sint64, number_sfixed64, number_fixed64, repeated_number_int64, optional_number_int64, commented_number_int64
func (x *Int64EncodingTest) UnmarshalJSONOnekit(data []byte, opts protojson.UnmarshalOptions) error {
