...
// MarshalJSONOnekit implements onekitMarshaler for User.
// This method handles nullable fields: middle_name, age, is_verified
func (x *User) MarshalJSONOnekit(opts protojson.MarshalOptions) ([]byte, error) {
	if x == nil {
...
// UnmarshalJSONOnekit implements onekitUnmarshaler for User.
// This method handles nullable fields: middle_name, age, is_verified
func (x *User) UnmarshalJSONOnekit(data []byte, opts protojson.UnmarshalOptions) error {
