...
// MarshalJSONOnekit implements onekitMarshaler for FlattenedEvent.
// This method handles oneof discriminator fields: content
func (x *FlattenedEvent) MarshalJSONOnekit(opts protojson.MarshalOptions) ([]byte, error) {
	if x == nil {
	...
	case *FlattenedEvent_Text:
		...
		// Flatten: forward opts to variant via MarshalJSONOnekit when available
		if inner := x.GetText(); inner != nil {
			...
			if m, ok := any(inner).(interface {
				...
				variantData, varErr = m.MarshalJSONOnekit(opts)
			} else {
...
// UnmarshalJSONOnekit implements onekitUnmarshaler for FlattenedEvent.
// This method handles oneof discriminator fields: content
func (x *FlattenedEvent) UnmarshalJSONOnekit(data []byte, opts protojson.UnmarshalOptions) error {
	...
	if discRaw, ok := raw["type"]; ok {
		...
		case "text":
			...
			if u, ok := any(variant).(interface {
				...
				if err := u.UnmarshalJSONOnekit(variantData, opts); err != nil {
...
// MarshalJSONOnekit implements onekitMarshaler for NestedEvent.
// This method handles oneof discriminator fields: content
func (x *NestedEvent) MarshalJSONOnekit(opts protojson.MarshalOptions) ([]byte, error) {
	if x == nil {
		return []byte("null"), nil
	}
...
// UnmarshalJSONOnekit implements onekitUnmarshaler for NestedEvent.
// This method handles oneof discriminator fields: content
func (x *NestedEvent) UnmarshalJSONOnekit(data []byte, opts protojson.UnmarshalOptions) error {
	// Parse into a map to read discriminator fields
	var raw map[string]json.RawMessage
	if err := json.Unmarshal(data, &raw); err != nil {
		return err
	...
	if discRaw, ok := raw["kind"]; ok {
		...
		switch disc {
		case "text":
			// Non-flattened unmarshal: forward opts to child's UnmarshalJSONOnekit if available
			if variantRaw, exists := raw["text"]; exists {
				variant := &TextContent{}
				if u, ok := any(variant).(interface {
					UnmarshalJSONOnekit([]byte, protojson.UnmarshalOptions) error
				}); ok {
					if err := u.UnmarshalJSONOnekit(variantRaw, opts); err != nil {
						return fmt.Errorf("failed to unmarshal variant %s: %%w", "Text", err)
					}
