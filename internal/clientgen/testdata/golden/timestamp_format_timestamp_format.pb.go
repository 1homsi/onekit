...
// MarshalJSONOnekit implements onekitMarshaler for TimestampFormatTest.
// This method handles timestamp_format fields: unix_seconds_ts, unix_millis_ts, date_ts
func (x *TimestampFormatTest) MarshalJSONOnekit(opts protojson.MarshalOptions) ([]byte, error) {
	if x == nil {
...
// UnmarshalJSONOnekit implements onekitUnmarshaler for TimestampFormatTest.
// This method handles timestamp_format fields: unix_seconds_ts, unix_millis_ts, date_ts
func (x *TimestampFormatTest) UnmarshalJSONOnekit(data []byte, opts protojson.UnmarshalOptions) error {
