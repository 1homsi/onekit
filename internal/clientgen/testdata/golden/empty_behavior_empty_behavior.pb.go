...
// MarshalJSONOnekit implements onekitMarshaler for Response.
// This method handles empty_behavior fields: metadata_preserve, metadata_null, metadata_omit, settings
func (x *Response) MarshalJSONOnekit(opts protojson.MarshalOptions) ([]byte, error) {
	if x == nil {
...
// UnmarshalJSONOnekit implements onekitUnmarshaler for Response.
// This method handles empty_behavior fields: metadata_preserve, metadata_null, metadata_omit, settings
func (x *Response) UnmarshalJSONOnekit(data []byte, opts protojson.UnmarshalOptions) error {
