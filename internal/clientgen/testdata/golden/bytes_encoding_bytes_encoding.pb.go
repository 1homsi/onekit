...
// MarshalJSONOnekit implements onekitMarshaler for BytesEncodingTest.
// This method handles bytes_encoding fields: base64_raw_data, base64url_data, base64url_raw_data, hex_data
func (x *BytesEncodingTest) MarshalJSONOnekit(opts protojson.MarshalOptions) ([]byte, error) {
	if x == nil {
...
// UnmarshalJSONOnekit implements onekitUnmarshaler for BytesEncodingTest.
// This method handles bytes_encoding fields: base64_raw_data, base64url_data, base64url_raw_data, hex_data
func (x *BytesEncodingTest) UnmarshalJSONOnekit(data []byte, opts protojson.UnmarshalOptions) error {
